...
import pymysql
from pymysql import cursors  # type: ignore

app = Flask(__name__)

# MySQL Configuration
mysql_host = 'host.docker.internal'  # Use 'host.docker.internal' to connect to the MySQL running on your local machine
mysql_user = 'root'
mysql_password = 'power@123'
mysql_db = 'world'
